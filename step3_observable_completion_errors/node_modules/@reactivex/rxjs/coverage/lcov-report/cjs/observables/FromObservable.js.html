...
<html lang="en">
<head>
    <title>Code coverage report for cjs/observables/FromObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/observables/FromObservable.js</span></h1>
    <h2>
        Statements: <span class="metric">91.38% <small>(53 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64.71% <small>(22 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(7 / 7)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94% <small>(47 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/observables/</a> &#187; FromObservable.js</div>
</div>
<div class="body">
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ish) {
            if (isArray(ish)) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (ish instanceof _Observable3['default']) {
<span class="cstat-no" title="statement not covered" >                    return ish;</span>
                }
                return new FromObservable(ish, scheduler);
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof ish[_utilSymbol_iterator2['default']] === 'function') {
                return new _IteratorObservable2['default'](ish, null, null, scheduler);
            }
        }
<span class="cstat-no" title="statement not covered" >        throw new TypeError(typeof ish + ' is not observable');</span>
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return ish[_utilSymbol_observable2['default']]().subscribe(new _operatorsObserveOnSupport.ObserveOnSubscriber(subscriber, scheduler, 0));</span>
        }
    };
&nbsp;
...
//# sourceMappingURL=FromObservable.js.map</pre></td></tr>
</table></pre>
