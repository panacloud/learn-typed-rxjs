...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/first.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/first.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; first.js</div>
</div>
<div class="body">
...
&nbsp;
    FirstSubscriber.prototype._complete = function _complete() {
        ...
        if (!this.hasCompleted &amp;&amp; typeof this.defaultValue !== 'undefined') {
            ...
            destination.complete();
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.hasCompleted) {
...
//# sourceMappingURL=first.js.map</pre></td></tr>
</table></pre>
