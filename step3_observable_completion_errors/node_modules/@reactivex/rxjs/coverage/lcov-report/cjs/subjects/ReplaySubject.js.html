...
<html lang="en">
<head>
    <title>Code coverage report for cjs/subjects/ReplaySubject.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/subjects/ReplaySubject.js</span></h1>
    <h2>
        Statements: <span class="metric">95.31% <small>(61 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">73.53% <small>(25 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(10 / 10)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">98.15% <small>(53 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/subjects/</a> &#187; ReplaySubject.js</div>
</div>
<div class="body">
...
&nbsp;
        _Subject.call(this);
        this.events = [];
        this.bufferSize = bufferSize &lt; 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: bufferSize;
        this._windowTime = _windowTime &lt; 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: _windowTime;
...
&nbsp;
    ReplaySubject.prototype._getEvents = function _getEvents(now) {
        ...
        while (spliceCount &lt; eventsCount) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (now - events[spliceCount].time &lt; _windowTime) {
                break;
            }
<span class="cstat-no" title="statement not covered" >            spliceCount += 1;</span>
        }
...
//# sourceMappingURL=ReplaySubject.js.map</pre></td></tr>
</table></pre>
