...
<html lang="en">
<head>
    <title>Code coverage report for cjs/subjects/SubjectSubscription.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/subjects/SubjectSubscription.js</span></h1>
    <h2>
        Statements: <span class="metric">92.68% <small>(38 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">66.67% <small>(18 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(6 / 6)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.97% <small>(32 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/subjects/</a> &#187; SubjectSubscription.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1188</span>
...
<span class="cstat-no" title="statement not covered" >            return;</span>
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.observer instanceof _Subscriber2['default']) {
            this.observer.unsubscribe();
        }
        var subscriberIndex = observers.indexOf(this.observer);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (subscriberIndex !== -1) {
...
//# sourceMappingURL=SubjectSubscription.js.map</pre></td></tr>
</table></pre>
