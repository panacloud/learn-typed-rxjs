...
<html lang="en">
<head>
    <title>Code coverage report for cjs/schedulers/FutureAction.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/schedulers/FutureAction.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">92.31% <small>(36 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/schedulers/</a> &#187; FutureAction.js</div>
</div>
<div class="body">
...
&nbsp;
    FutureAction.prototype.schedule = function schedule(state) {
        var _this = this;
&nbsp;
        var delay = arguments.length &lt;= 1 || arguments[1] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: arguments[1];
&nbsp;
...
//# sourceMappingURL=FutureAction.js.map</pre></td></tr>
</table></pre>
