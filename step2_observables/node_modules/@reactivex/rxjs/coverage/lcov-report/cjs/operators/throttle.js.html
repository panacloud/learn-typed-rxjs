...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/throttle.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/throttle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; throttle.js</div>
</div>
<div class="body">
...
function throttle(delay) {
    var scheduler = arguments.length &lt;= 1 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1] === undefined </span>? _schedulersNextTick2['default'] : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1];</span>
&nbsp;
...
&nbsp;
    ThrottleSubscriber.prototype.clearThrottle = function clearThrottle() {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (throttled) {
...
//# sourceMappingURL=throttle.js.map</pre></td></tr>
</table></pre>
