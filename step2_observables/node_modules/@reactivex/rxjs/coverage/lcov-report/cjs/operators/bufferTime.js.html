...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/bufferTime.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/bufferTime.js</span></h1>
    <h2>
        Statements: <span class="metric">97.83% <small>(90 / 92)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">67.65% <small>(23 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(17 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(84 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; bufferTime.js</div>
</div>
<div class="body">
...
function bufferTime(bufferTimeSpan) {
    var bufferCreationInterval = arguments.length &lt;= 1 || arguments[1] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: arguments[1];
    var scheduler = arguments.length &lt;= 2 || arguments[2] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >_schedulersNextTick2['default'] </span>: arguments[2];
&nbsp;
...
function dispatchBufferTimeSpanOnly(state) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (prevBuffer) {
        subscriber.closeBuffer(prevBuffer);
    }
    state.buffer = subscriber.openBuffer();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!subscriber.isUnsubscribed) {
...
//# sourceMappingURL=bufferTime.js.map</pre></td></tr>
</table></pre>
