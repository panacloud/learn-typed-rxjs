...
<html lang="en">
<head>
    <title>Code coverage report for src/observables/RangeObservable.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/observables/</a> RangeObservable.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  static create(<span class="cstat-no" title="statement not covered" >start: number = 0,</span> <span class="cstat-no" title="statement not covered" >end: number = 0,</span> scheduler?: Scheduler): Observable&lt;number&gt; {
