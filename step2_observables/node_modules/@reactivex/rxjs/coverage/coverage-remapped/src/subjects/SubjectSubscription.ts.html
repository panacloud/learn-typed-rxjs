...
<html lang="en">
<head>
    <title>Code coverage report for src/subjects/SubjectSubscription.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/subjects/</a> SubjectSubscription.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.observer instanceof Subscriber) {
