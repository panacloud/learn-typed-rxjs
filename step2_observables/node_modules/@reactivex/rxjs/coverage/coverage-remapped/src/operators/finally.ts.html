...
<html lang="en">
<head>
    <title>Code coverage report for src/operators/finally.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operators/</a> finally.ts
    </h1>
    <div class='clearfix'>
...
export default function _finally&lt;T&gt;(finallySelector: () =&gt; void, thisArg?: any) {
  return this.lift(new FinallyOperator(thisArg ?
    &lt;() =&gt; void&gt; <span class="branch-0 cbranch-no" title="branch not covered" >bindCallback(finallySelector, thisArg, 2) </span>:
    finallySelector));
}
&nbsp;
