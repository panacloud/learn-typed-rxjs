...
<html lang="en">
<head>
    <title>Code coverage report for src/operators/windowTime.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operators/</a> windowTime.ts
    </h1>
    <div class='clearfix'>
...
export default function windowTime&lt;T&gt;(windowTimeSpan: number,
                                      windowCreationInterval: number = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span>
