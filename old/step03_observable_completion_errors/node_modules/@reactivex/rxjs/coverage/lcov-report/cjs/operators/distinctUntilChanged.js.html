...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/distinctUntilChanged.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/distinctUntilChanged.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; distinctUntilChanged.js</div>
</div>
<div class="body">
...
function distinctUntilChanged(compare, thisArg) {
    return this.lift(new DistinctUntilChangedOperator(thisArg ? <span class="branch-0 cbranch-no" title="branch not covered" >_utilBindCallback2['default'](compare, thisArg, 2) </span>: compare));
}
&nbsp;
...
//# sourceMappingURL=distinctUntilChanged.js.map</pre></td></tr>
</table></pre>
