...
<html lang="en">
<head>
    <title>Code coverage report for cjs/observables/ErrorObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/observables/ErrorObservable.js</span></h1>
    <h2>
        Statements: <span class="metric">83.33% <small>(30 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/observables/</a> &#187; ErrorObservable.js</div>
</div>
<div class="body">
...
&nbsp;
    ErrorObservable.dispatch = <span class="fstat-no" title="function not covered" >function dispatch(_ref) {</span>
<span class="cstat-no" title="statement not covered" >        var error = _ref.error;</span>
<span class="cstat-no" title="statement not covered" >        var subscriber = _ref.subscriber;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        subscriber.error(error);</span>
    };
&nbsp;
    ErrorObservable.prototype._subscribe = function _subscribe(subscriber) {
        var error = this.error;
        var scheduler = this.scheduler;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (scheduler) {
<span class="cstat-no" title="statement not covered" >            subscriber.add(scheduler.schedule(ErrorObservable.dispatch, 0, {</span>
...
//# sourceMappingURL=ErrorObservable.js.map</pre></td></tr>
</table></pre>
