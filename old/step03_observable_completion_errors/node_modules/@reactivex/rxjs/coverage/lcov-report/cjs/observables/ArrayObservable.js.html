...
<html lang="en">
<head>
    <title>Code coverage report for cjs/observables/ArrayObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/observables/ArrayObservable.js</span></h1>
    <h2>
        Statements: <span class="metric">94.2% <small>(65 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">80.56% <small>(29 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(9 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.72% <small>(59 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/observables/</a> &#187; ArrayObservable.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!scheduler &amp;&amp; array.length === 1) {
<span class="cstat-no" title="statement not covered" >            this._isScalar = true;</span>
<span class="cstat-no" title="statement not covered" >            this.value = array[0];</span>
        }
    }
&nbsp;
...
//# sourceMappingURL=ArrayObservable.js.map</pre></td></tr>
</table></pre>
