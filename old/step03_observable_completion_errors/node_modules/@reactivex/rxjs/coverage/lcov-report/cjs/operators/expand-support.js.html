...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/expand-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/expand-support.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">93.55% <small>(58 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; expand-support.js</div>
</div>
<div class="body">
...
var ExpandOperator = (function () {
    function ExpandOperator(project) {
        var concurrent = arguments.length &lt;= 1 || arguments[1] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >Number.POSITIVE_INFINITY </span>: arguments[1];
&nbsp;
...
&nbsp;
    function ExpandSubscriber(destination, project) {
        var concurrent = arguments.length &lt;= 2 || arguments[2] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >Number.POSITIVE_INFINITY </span>: arguments[2];
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (concurrent &lt; Number.POSITIVE_INFINITY) {
...
&nbsp;
    ExpandSubscriber.prototype._next = function _next(value) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.active &lt; this.concurrent) {
            var result = _utilTryCatch2['default'](this.project)(value, index);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (result === _utilErrorObject.errorObject) {
<span class="cstat-no" title="statement not covered" >                this.destination.error(result.e);</span>
            } else {
                if (result._isScalar) {
...
<span class="cstat-no" title="statement not covered" >            this.buffer.push(value);</span>
        }
    };
&nbsp;
...
&nbsp;
    ExpandSubscriber.prototype.notifyComplete = function notifyComplete(innerSub) {
        ...
        this.active--;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >buffer.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >            this._next(buffer.shift());</span>
        }
        if (this.hasCompleted &amp;&amp; this.active === 0) {
            this.destination.complete();
        }
...
//# sourceMappingURL=expand-support.js.map</pre></td></tr>
</table></pre>
