...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/extended/find-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/extended/find-support.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/extended/</a> &#187; find-support.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        this.thisArg = thisArg;
        this.index = 0;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof predicate === 'function') {
...
&nbsp;
    FindValueSubscriber.prototype._next = function _next(value) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (predicate === undefined) {
<span class="cstat-no" title="statement not covered" >            this.destination.error(new TypeError('predicate must be a function'));</span>
        }
...
//# sourceMappingURL=find-support.js.map</pre></td></tr>
</table></pre>
