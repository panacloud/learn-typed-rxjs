...
<html lang="en">
<head>
    <title>Code coverage report for cjs/Subject.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/Subject.js</span></h1>
    <h2>
        Statements: <span class="metric">93.06% <small>(134 / 144)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">cjs/</a> &#187; Subject.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2462</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1877</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1877</span>
...
<span class="cline-any cline-yes">1308</span>
<span class="cline-any cline-yes">3</span>
<span class="cline-any cline-yes">3</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">4038</span>
<span class="cline-any cline-yes">32</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-yes">26</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">896</span>
<span class="cline-any cline-yes">896</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-yes">4006</span>
<span class="cline-any cline-yes">3195</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
&nbsp;
    Subject.prototype._subscribe = function _subscribe(subscriber) {
        if (subscriber.isUnsubscribed) {
            ...
            subscriber.complete();
            return;
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isUnsubscribed) {
<span class="cstat-no" title="statement not covered" >            throw new Error("Cannot subscribe to a disposed Subject.");</span>
        }
        this.observers.push(subscriber);
        return new _subjectsSubjectSubscription2['default'](this, subscriber);
    };
&nbsp;
    Subject.prototype.add = <span class="fstat-no" title="function not covered" >function add(subscription) {</span>
<span class="cstat-no" title="statement not covered" >        subscriptionAdd.call(this, subscription);</span>
    };
&nbsp;
    Subject.prototype.remove = <span class="fstat-no" title="function not covered" >function remove(subscription) {</span>
<span class="cstat-no" title="statement not covered" >        subscriptionRemove.call(this, subscription);</span>
    };
&nbsp;
...
&nbsp;
    Subject.prototype.next = function next(value) {
        ...
        this._next(value);
        this.dispatching = false;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.errorSignal) {
<span class="cstat-no" title="statement not covered" >            this.error(this.errorInstance);</span>
        } else if (this.completeSignal) {
            this.complete();
        }
    };
&nbsp;
    Subject.prototype.error = function error(err) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.dispatching) {
...
&nbsp;
    Subject.prototype._error = function _error(err) {
        var index = -1;
...
&nbsp;
    BidirectionalSubject.prototype.next = function next(value) {
        subscriberNext.call(this, value);
    };
&nbsp;
    BidirectionalSubject.prototype.error = <span class="fstat-no" title="function not covered" >function error(err) {</span>
<span class="cstat-no" title="statement not covered" >        subscriberError.call(this, err);</span>
    };
&nbsp;
...
&nbsp;
    BidirectionalSubject.prototype._next = function _next(value) {
        _subscriberNext.call(this, value);
    };
&nbsp;
    BidirectionalSubject.prototype._error = <span class="fstat-no" title="function not covered" >function _error(err) {</span>
<span class="cstat-no" title="statement not covered" >        _subscriberError.call(this, err);</span>
    };
&nbsp;
...
//# sourceMappingURL=Subject.js.map</pre></td></tr>
</table></pre>
