...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/sample.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/sample.js</span></h1>
    <h2>
        Statements: <span class="metric">94.23% <small>(49 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; sample.js</div>
</div>
<div class="body">
...
&nbsp;
    SampleNoficationSubscriber.prototype._error = <span class="fstat-no" title="function not covered" >function _error(err) {</span>
<span class="cstat-no" title="statement not covered" >        this.parent.error(err);</span>
    };
&nbsp;
...
//# sourceMappingURL=sample.js.map</pre></td></tr>
</table></pre>
