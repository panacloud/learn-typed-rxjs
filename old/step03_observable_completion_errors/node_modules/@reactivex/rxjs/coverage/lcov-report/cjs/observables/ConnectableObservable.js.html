...
<html lang="en">
<head>
    <title>Code coverage report for cjs/observables/ConnectableObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/observables/ConnectableObservable.js</span></h1>
    <h2>
        Statements: <span class="metric">96.39% <small>(80 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">68.75% <small>(22 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(18 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">98.67% <small>(74 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/observables/</a> &#187; ConnectableObservable.js</div>
</div>
<div class="body">
...
&nbsp;
    ConnectableObservable.prototype.connect = function connect() {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (subscription &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!subscription.isUnsubscribed)</span> {
...
&nbsp;
    function RefCountObservable(connectable) {
        var refCount = arguments.length &lt;= 1 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1] === undefined </span>? 0 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1];</span>
&nbsp;
...
//# sourceMappingURL=ConnectableObservable.js.map</pre></td></tr>
</table></pre>
