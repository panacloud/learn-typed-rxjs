...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/switchMap.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/switchMap.js</span></h1>
    <h2>
        Statements: <span class="metric">94.67% <small>(71 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(24 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(14 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.01% <small>(65 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; switchMap.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            destination.error(result.e);</span>
        } else {
...
&nbsp;
        if (resultSelector) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (result === _utilErrorObject.errorObject) {
<span class="cstat-no" title="statement not covered" >                destination.error(_utilErrorObject.errorObject.e);</span>
            } else {
...
//# sourceMappingURL=switchMap.js.map</pre></td></tr>
</table></pre>
