...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/delay.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/delay.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; delay.js</div>
</div>
<div class="body">
...
&nbsp;
    DelaySubscriber.prototype.scheduleNotification = function scheduleNotification(notification) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.errored === true) {
...
//# sourceMappingURL=delay.js.map</pre></td></tr>
</table></pre>
