...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/finally.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/finally.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; finally.js</div>
</div>
<div class="body">
...
function _finally(finallySelector, thisArg) {
    return this.lift(new FinallyOperator(thisArg ? <span class="branch-0 cbranch-no" title="branch not covered" >_utilBindCallback2['default'](finallySelector, thisArg, 2) </span>: finallySelector));
}
&nbsp;
...
//# sourceMappingURL=finally.js.map</pre></td></tr>
</table></pre>
