...
<html lang="en">
<head>
    <title>Code coverage report for cjs/observables/TimerObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/observables/TimerObservable.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/observables/</a> &#187; TimerObservable.js</div>
</div>
<div class="body">
...
&nbsp;
    function TimerObservable(dueTime, period, scheduler) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (dueTime === undefined) <span class="cstat-no" title="statement not covered" >dueTime = 0;</span>
&nbsp;
...
&nbsp;
        ...
        if (_utilIsNumeric2['default'](period)) {
            this._period = Number(period) &lt; 1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >1 </span>|| Number(period);
...
//# sourceMappingURL=TimerObservable.js.map</pre></td></tr>
</table></pre>
