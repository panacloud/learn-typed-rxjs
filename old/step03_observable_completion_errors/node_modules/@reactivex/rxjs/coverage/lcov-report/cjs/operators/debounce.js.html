...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/debounce.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/debounce.js</span></h1>
    <h2>
        Statements: <span class="metric">96% <small>(96 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">73.68% <small>(28 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(23 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(78 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; debounce.js</div>
</div>
<div class="body">
...
&nbsp;
    DurationSelectorSubscriber.prototype.debounceNext = function debounceNext() {
        ...
        if (this.currentIndex === parent.index) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isUnsubscribed) {
                this.unsubscribe();
            }
        }
    };
...
//# sourceMappingURL=debounce.js.map</pre></td></tr>
</table></pre>
