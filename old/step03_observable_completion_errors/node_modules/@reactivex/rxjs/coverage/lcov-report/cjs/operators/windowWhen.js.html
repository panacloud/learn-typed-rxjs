...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operators/windowWhen.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operators/windowWhen.js</span></h1>
    <h2>
        Statements: <span class="metric">97.7% <small>(85 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operators/</a> &#187; windowWhen.js</div>
</div>
<div class="body">
...
&nbsp;
    WindowSubscriber.prototype.unsubscribe = function unsubscribe() {
        _Subscriber.prototype.unsubscribe.call(this);
        this._unsubscribeClosingNotification();
    };
&nbsp;
    WindowSubscriber.prototype._unsubscribeClosingNotification = function _unsubscribeClosingNotification() {
        var closingNotification = this.closingNotification;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (closingNotification) {
...
&nbsp;
    WindowSubscriber.prototype.openWindow = function openWindow() {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (prevWindow) {
            prevWindow.complete();
        }
...
//# sourceMappingURL=windowWhen.js.map</pre></td></tr>
</table></pre>
