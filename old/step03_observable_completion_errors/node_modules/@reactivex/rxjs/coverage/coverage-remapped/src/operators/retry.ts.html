...
<html lang="en">
<head>
    <title>Code coverage report for src/operators/retry.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operators/</a> retry.ts
    </h1>
    <div class='clearfix'>
...
class RetryMoreSubscriber&lt;T&gt; extends Subscriber&lt;T&gt; {
  constructor(private parent: FirstRetrySubscriber&lt;T&gt;,
              private count: number,
              private retried: number = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> {
    super(null);
  }
&nbsp;
  _next(value: T) {
